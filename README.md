...
An automated script using Playwright to log into the FAA WMT Scheduler, navigate through Okta authentication, and download the current and next pay period schedules to a JSON file. The JSON file could then be read by (for example) a desktop widget to display your upcoming schedule.
